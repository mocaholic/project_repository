...
@Component({
    selector: 'app-board-resident',
    templateUrl: './board-resident.page.html',
    styleUrls: ['./board-resident.page.scss'],
})
export class BoardResidentPage extends BasePage implements OnInit {
    /**
     * 게시판 타입
     */
     ...
     */
    goInsertPage(): void {
        this.pageUtils.navigateForward(GlobalConstants.MENU.LC_CM_CSB_INSERT.URL);
    }
