...
@Component({
    selector: 'app-board-news-view',
    templateUrl: './board-news.view.page.html',
    styleUrls: ['./board-news.view.page.scss'],
})
export class BoardNewsViewPage extends BasePage implements OnInit {
    /**
     * 게시판 타입
     */
