    ...
    var events = {
        ...
        blur: function (event) {
            ...
            if (select.hasClass("open")) {
                select.removeClass("focus")
                   .trigger("close")
                   .unbind("keydown");
                $(select).unbind("click", events.blur);
            }
        },
        ...
        open: function (event) {
            if (!$(this).hasClass("open"));
            {
                ...
                //$($(this)).click({ select: $(this) }, events.blur);
                //event.preventDefault();
                // Before open close
                $(this).parent().parent().find('.selectify').removeClass("focus").removeClass("open");
            	$(this).parent().parent().find('.selectify .options').hide();
    ...
    var methods = {
        init: function (args) {
            ...
            return $(this).each(function () {
                ...
                if (!data) {
                    var select = $('<div />', {
                        "class": 'selectify focus',
                        "tabindex": "0"
                    }).bind("click", { select: $this }, events.focus)
