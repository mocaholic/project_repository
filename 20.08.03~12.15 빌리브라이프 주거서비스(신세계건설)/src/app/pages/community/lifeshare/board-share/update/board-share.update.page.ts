...
@Component({
    selector: 'app-board-share-update',
    templateUrl: './board-share.update.page.html',
    styleUrls: ['./board-share.update.page.scss'],
})
export class BoardShareUpdatePage extends BasePage implements OnInit {
