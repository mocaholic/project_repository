...
@Component({
    selector: 'app-board-share-view',
    templateUrl: './board-share.view.page.html',
    styleUrls: ['./board-share.view.page.scss'],
})
export class BoardShareViewPage extends BasePage implements OnInit {
    /**
     * 게시판 타입
     */
